          ...
          children: [
            ...
            Selector<BluetoothProvider, String>(
              ...
              builder: (context, msg, _) {
                String out = msg;
                if (msg.contains('CONNECTING TO')) out = loc.translate('connecting_to', [device.name]);
                else if (msg == 'EXCHANGING DATA...') out = loc.translate('data_exchange');
                else if (msg.contains('ATTEMPT')) out = loc.translate('attempt', [msg.split('#').last]);
