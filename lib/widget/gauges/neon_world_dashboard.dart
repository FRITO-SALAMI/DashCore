...
class _NeonWorldDashboardState extends State<NeonWorldDashboard>
  ...
  Widget build(BuildContext context) {
    ...
    final mapColor = accentColor; // El mapa ahora sigue el color principal
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          // ==================================================
          // WORLD MAP (capa estática + capa dinámica separadas)
          // ==================================================
          Center(
            child: AspectRatio(
              ...
              child: SizedBox(
                ...
                child: _CachedWorldMap(
                  color: accentColor, // Usar accentColor directamente
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                _TempGauge(temp: widget.coolantTemp, color: accentColor),
          ...
          Positioned(
            bottom: 40,
            left: 30,
            child: _SmallMusicHub(music: music, color: accentColor),
          ),

          Positioned(
            bottom: 10,
            right: 40,
            child: _NeonSpeedometer(speed: widget.speed, color: accentColor),
          ),
...
class _TempGauge extends StatelessWidget {
  final int temp;
  final Color color;
  const _TempGauge({required this.temp, required this.color});
        ...
        Row(
          ...
          children: [
            Padding(
              ...
              child: Icon(Icons.thermostat_rounded, color: color.withOpacity(0.5), size: 18),
            ),
            Text('$temp',
                style: const TextStyle(
                    color: Colors.white, fontSize: 44, fontWeight: FontWeight.w900, height: 1)),
            Text('°C', style: TextStyle(color: color, fontSize: 18, fontWeight: FontWeight.bold)),
          ],
        ),
...
class _VoltageDisplay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        Icon(Icons.bolt_rounded, color: color.withOpacity(0.7), size: 20),
        ...
        const SizedBox(width: 4),
        Text('V', style: TextStyle(color: color, fontSize: 16, fontWeight: FontWeight.bold)),
      ],
    );
  }
}
...
// SPEEDOMETER
// ============================================================
class _NeonSpeedometer extends StatelessWidget {
  final int speed;
  final Color color;
  const _NeonSpeedometer({required this.speed, required this.color});
      ...
      child: Stack(
        ...
        children: [
          CustomPaint(
            ...
            painter: _SpeedoPainter(speed: speed, color: color),
          ),
          Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              ...
              Text('KM/H',
                  style: TextStyle(
                      color: color.withOpacity(0.5), fontSize: 14, fontWeight: FontWeight.bold, letterSpacing: 4)),
            ],
          ),
        ],
      ),
...
class _SpeedoPainter extends CustomPainter {
  final int speed;
  final Color color;
  _SpeedoPainter({required this.speed, required this.color});
