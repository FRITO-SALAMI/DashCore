                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            _RacingHudGadget(label: 'OIL TEMP', value: '$coolantTemp', unit: tempUnit, color: Colors.cyanAccent),
                    ...
                    Expanded(
                      flex: 2,
                      child: Center(
                        child: _RacingSpeedCenter(speed: speed, isCompetitive: isCompetitive, color: currentAccent),
                      ),
                    ),
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            _RacingHudGadget(label: 'VOLTS', value: voltage.toStringAsFixed(1), unit: 'V', color: Colors.orangeAccent, isRight: true),
                            const SizedBox(height: 40),
