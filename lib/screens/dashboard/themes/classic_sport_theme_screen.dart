...
class _ClassicSportThemeScreenState extends State<ClassicSportThemeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color displayAccent = isSpeedWarning ? Colors.redAccent : _currentAccent;
    final scale = (isCompetitive || isSpeedWarning) ? 1.15 : 1.1;
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        gradient: RadialGradient(
          ...
          radius: 1.2,
          colors: [
            displayAccent.withOpacity(0.08),
            _bg,
          ],
        ),
      ),
        ...
        children: [
          ...
          Padding(
            ...
            child: SafeArea(
              child: Column(
                children: [
                  MusicHub(accentColor: displayAccent, width: 300),
                  Expanded(
                    child: LayoutBuilder(
                                ...
                                Expanded(
                                  child: Transform.scale(
                                    ...
                                    child: _AnalogClusterGauge(
                                      ...
                                      needleColor: (isCompetitive || isSpeedWarning) ? Colors.white : _red,
                                    ...
                                    children: [
                                      Transform.scale(
                                        ...
                                        child: _AnalogClusterGauge(
                                          ...
                                          unitLabel: 'x1000/min',
                                          accentColor: isTempWarning ? Colors.redAccent : displayAccent,
                                        ...
                                        Positioned(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              border: Border.all(color: displayAccent, width: 2),
                                              borderRadius: BorderRadius.circular(12),
                                              boxShadow: [
                                                 BoxShadow(color: displayAccent.withOpacity(0.3), blurRadius: 15),
                                              ],
                                            ),
                                            child: Text(
                                              widget.data.gear,
...
class _NowPlayingBar extends StatelessWidget {
  const _NowPlayingBar({required this.accentColor});
  final Color accentColor;
        ...
        children: [
          Row(
            ...
            children: [
              ...
              const SizedBox(width: 15),
              IconButton(
                icon: Icon(music.isPlaying ? Icons.pause : Icons.play_arrow, color: Colors.white70, size: 16),
          ...
          ClipRRect(
            ...
            child: SizedBox(
              ...
              child: LinearProgressIndicator(
                ...
                valueColor: AlwaysStoppedAnimation(accentColor.withOpacity(0.8)),
              ),
            ),
          ),
        ],
...
class _CenterReadout extends StatelessWidget {
  ...
  final double? ambientTempC;
  final Color accentColor;
  final bool isSpeedWarning;

  @override
  Widget build(BuildContext context) {
    final displayColor = isSpeedWarning ? Colors.redAccent : const Color(0xFFF4D35E);
    ...
    return Column(
      ...
      children: [
        ...
        AnimatedDefaultTextStyle(
          ...
          style: TextStyle(
            color: displayColor,
            fontSize: isSpeedWarning ? 84 : 72,
            fontWeight: FontWeight.w900,
            height: 1,
            letterSpacing: -2,
          ),
          child: Text(speedKmh.round().toString()),
        ),
        const Text(
          'km/h',
...
class _AnalogClusterGauge extends StatefulWidget {
  ...
  @override
  State<_AnalogClusterGauge> createState() => _AnalogClusterGaugeState();
}

class _AnalogClusterGaugeState extends State<_AnalogClusterGauge> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant _AnalogClusterGauge oldWidget) {
              ...
              children: [
                Container(
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: widget.isWarning ? Colors.redAccent.withOpacity(0.5) : Colors.white24, width: 2),
                  ),
                ),
                CustomPaint(
                  size: Size.infinite,
                  painter: _ArcGaugePainter(
                    fraction: fraction,
                    majorLabels: widget.majorLabels,
                    minorPerMajor: 4,
                    accentColor: displayAccent,
                    needleColor: widget.isWarning ? Colors.white : widget.needleColor,
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Icon(widget.innerIcon, size: 14, color: displayAccent),
                ...
                Positioned(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(color: displayAccent.withOpacity(0.3), fontSize: 12, fontWeight: FontWeight.w900, letterSpacing: 2),
                  ),
                ),
              ],
            ),
